...
$selectquery= "select *from tb_ride ";

$query=mysqli_query($con,$selectquery);

$nums=mysqli_num_rows($query);

echo "<table border='1px' cellpadding='15px' cellspacing='0px' >";
echo "<thead>";
echo "<tr style='font-size:30px; text-align:center;background-color:#cdea9f;'>";
